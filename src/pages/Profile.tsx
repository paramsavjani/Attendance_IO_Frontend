    ...
    <div className="space-y-2 pb-2">
      ...
      <div className="flex items-center justify-center pt-2 pb-4">
        ...
        >
          ...
          <span className="text-[10px] bg-gradient-to-r from-blue-400 via-purple-400 to-pink-400 bg-clip-text text-transparent font-bold tracking-wider group-hover:opacity-80 transition-opacity">
            PARAM SAVJANI
          </span>
          <Heart className="w-3 h-3 text-red-500/80 fill-red-500/20 animate-pulse" />
        </a>
      </div>
