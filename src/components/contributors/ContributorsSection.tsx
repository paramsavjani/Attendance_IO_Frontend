    ...
    <div className="space-y-3 pt-2">
      ...
      <div className="grid grid-cols-1 gap-2">
        {ideaContributors.length > 0 && (
          <div className="relative overflow-hidden rounded-xl border border-yellow-500/20 bg-yellow-500/10 backdrop-blur-md transition-all">
            <button
        ...
        {testers.length > 0 && (
          <div className="relative overflow-hidden rounded-xl border border-blue-500/20 bg-blue-500/10 backdrop-blur-md transition-all">
            <button
